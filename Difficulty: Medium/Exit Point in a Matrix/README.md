<h2><a href="https://www.geeksforgeeks.org/problems/exit-point-in-a-matrix0905/1?_gl=1*1868g7k*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw_7PRBhDcARIsAMjV7jllqgrF0ZWs9ADDMtllkMPZmUxEYQJb6toWGqxY2E_cv2NfwwG7Hw8aAnKdEALw_wcB&gbraid=0AAAAAC9yBkC0zaeSUj9ia8bKez3ylsEqZ">Exit Point in a Matrix</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a matrix mat[][] of size <strong>n</strong> × <strong>m </strong>consisting of <strong>0</strong>s and <strong>1</strong>s. You start at the top-left cell (0, 0) and initially move in the left-to-right direction (i.e., towards the right).</span></p>
