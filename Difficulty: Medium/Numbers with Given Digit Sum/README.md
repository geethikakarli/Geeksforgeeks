<h2><a href="https://www.geeksforgeeks.org/problems/count-of-n-digit-numbers-whose-sum-of-digits-equals-to-given-sum0733/1?_gl=1*1lkohp9*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwguLSBhDLARIsAH-yPrENa2Aqn90Nf2mtu4C_HM7H_KqrvAX0oCtB7a-onJQdb5wZhIGb7-QaAm57EALw_wcB&gbraid=0AAAAAC9yBkALyCY9EJ1SdsHQ1ixoKD2bG">Numbers with Given Digit Sum</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two integers <strong>n</strong> and <strong>sum</strong>, determine the number of <strong>n-digit</strong> positive integers whose digits add up to sum.</span></p>
<ul>
