<h2><a href="https://www.geeksforgeeks.org/problems/construct-list-using-given-q-xor-queries/1?_gl=1*b65qwp*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwxb7RBhA5EiwAQ-AAdPaEgPHxK2s8nB17uVSv_mUx1OYJM-sxqvv95Rjob4mnIcf1aatpsxoCcWsQAvD_BwE&gbraid=0AAAAAC9yBkAXSFUV2IEWzMDqLFfznfQIQ">Construct List using XOR Queries</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">There is an array that initially contains only a single value,&nbsp;<strong>0</strong>.&nbsp;</span></p>
