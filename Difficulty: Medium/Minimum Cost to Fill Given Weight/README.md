<h2><a href="https://www.geeksforgeeks.org/problems/minimum-cost-to-fill-given-weight-in-a-bag1956/1?_gl=1*ld4vn7*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwornRBhCrARIsAON5exG09rbaMRFJrppmNglMuf7QG_LKJgt1mm0nvybeclpwE1Y1cICYxAkaAq2bEALw_wcB&gbraid=0AAAAAC9yBkBmcQrcJ5wKWl3aMVtqEpi5f">Minimum Cost to Fill Given Weight</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a bag of size w kg and you are provided costs of packets different weights of oranges in array cost[], find the minimum total cost to buy exactly w kg oranges<br></span></p>
<ul>
