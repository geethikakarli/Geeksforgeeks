<h2><a href="https://www.geeksforgeeks.org/problems/maximum-length-bitonic-subarray5730/1?_gl=1*9rx7bv*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw39zSBhDhARIsANammDvp-iK6gbGak9pDsendomBMLSbaLcPF-ffAAIbVLBEcO85m6_lhQGwaAnCxEALw_wcB&gbraid=0AAAAAC9yBkApXVukHCL9Tw7T_2nx9my0M">Longest Bitonic Subarray</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong>&nbsp;containing positive integers, return the maximum length of the bitonic<strong> </strong>subarray.</span></p>
