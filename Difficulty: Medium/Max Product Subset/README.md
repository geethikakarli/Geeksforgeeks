<h2><a href="https://www.geeksforgeeks.org/problems/maximum-product-subset-of-an-array/1?_gl=1*1i2uu3v*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwuO_QBhAWEiwAIkVhU8qeb_KjNwfqsC7uTpLyx2yj6UQC7IHwKSW21se8o7a8Dqj38SEpVRoC3hwQAvD_BwE&gbraid=0AAAAAC9yBkB7i3biLosEpJ8lxxRAWXnz1">Max Product Subset</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given an array <strong>arr[],</strong> find and return the maximum product possible with the <strong>subset</strong> of elements present in the array. </span></p>
