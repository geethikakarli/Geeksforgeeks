<h2><a href="https://www.geeksforgeeks.org/problems/minimum-insertions-to-make-two-arrays-equal/1?_gl=1*1s0yyso*_up*MQ..*_gs*MQ..&gclid=CjwKCAjw0o3SBhBVEiwAh28-jbANUMULTijxgJxKyS_ZmbnGzE_z1HueVAEh1b8IkzxCm4nmpn9G5xoCXXMQAvD_BwE&gbraid=0AAAAAC9yBkDcC_F8gLwLVdsIHTnKHwVha">Minimum Insert and Delete to Convert</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two arrays <strong>a[]</strong> and <strong>b[] </strong>of size n and m respectively, find the minimum number of <strong>insertions </strong>and <strong>deletions </strong>on the array a[], required to make both the arrays <strong>identical</strong>.</span></p>
